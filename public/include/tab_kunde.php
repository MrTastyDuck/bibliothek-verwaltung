  ...
  <div class="card-body">
   <form method="get" class="d-flex gap-3">
    <select name="auswahl_sort_kunden" class="form-select w-auto">
     <option value="kunde_nr">Nr</option>
  ...
  <div class="card mb-3">
   ...
   <div class="card-body">
    <form method="get" class="row g-3">
     ...
     <input class="form-control" name="add_k_tal" placeholder="Telefonnummer">
     <input class="form-control" name="add_k_datum" placeholder="Datum der Eintragung">
     <button class="btn btn-success" name="add_k">Hinzufügen</button>
    </form>
   </div>
  </div>
 <?php endif; ?>
  ...
  <div class="card mt-4">
   ...
   <div class="card-body">
    <form method="get">
     ...
     <input class="form-control mb-2" name="edit_k_vname" value="<?= $kunde['name'] ?>">
     <input class="form-control mb-2" name="edit_k_name" value="<?= $kunde['vname'] ?>">
    ...
    <tr>
     ...
     <td class="d-flex gap-2">
      <a class="btn btn-sm btn-warning"
       href="?k_edit_form=1&isbn=<?= urlencode($r['kunden_nr']) ?>">
       Bearbeiten
      </a>
      <a class="btn btn-sm btn-danger"
       href="?k_delete=<?= urlencode($r['kunden_nr']) ?>"
